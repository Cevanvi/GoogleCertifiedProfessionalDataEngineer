...
- Demo: Creating a Cloud SQL Instance and Loading Data
    ...
    - [Transcript](3.Storage_and_Databases/6.2.demo.creating_a_cloud_sql_instance_and_loading_data.md)
...
- Hands-on Lab Managing Google Cloud SQL Instances
    ...
    - [Transcript](3.Storage_and_Databases/labs/1.managing_google_cloud_sql_instances.md)
...
- Cloud Firestore
    ...
    - [Transcript](3.Storage_and_Databases/7.cloud_firestore.md)
...
- Hands-on Lab Exploring Cloud Firestore in Datastore Mode
    ...
    - [Transcript](3.Storage_and_Databases/labs/3.exploring_cloud_firestore_in_datastore_mode.md)
...
- Hands-on Lab Cloud Run Data in GCS and Firestore
    ...
    - [Transcript](3.Storage_and_Databases/labs/4.cloud_run_data_in_gcs_and_firestore.md)

- Cloud Spanner
    - [Video](https://drive.google.com/file/d/1ZBXE-9CG-IZebDzNdI2Cd8DDzhZe6SC3/view)
    - [Transcript](3.Storage_and_Databases/8.1.cloud_spanner.md)

- Cloud Spanner Demo: Working with Cloud Spanner
    - [Video](https://drive.google.com/file/d/1mJNba6_gMPz1jcUQtkteyRXAUSMgnQWv/view)
    - [Transcript](3.Storage_and_Databases/8.2.demo.working_with_cloud_spanner.md)
